...
---
= Configurar o armazenamento utilizando o Gestor de sistema SANtricity - Linux (iSCSI)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Sobre esta tarefa
Se for um utilizador iSCSI, fechou o assistente de configuração durante a configuração do iSCSI.
