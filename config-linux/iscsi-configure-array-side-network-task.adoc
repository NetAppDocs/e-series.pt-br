...
.Sobre esta tarefa
Esta tarefa descreve como acessar a configuração da porta iSCSI na página Hardware do System Manager. Você também pode acessar a configuração em menu:System[Settings > System > Configure iSCSI ports].
