...
---
= Criar sistemas de arquivos na Série E - SLES 12 (NVMe sobre FC)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para o SLES 12, você cria um sistema de arquivos no dispositivo dm desejado e monta o sistema de arquivos.
