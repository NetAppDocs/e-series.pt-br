...
summary: Para o SLES 12, você cria um sistema de arquivos no namespace e monta o sistema de arquivos. 
---
= Criar sistemas de arquivos na Série E - Linux SLES 12 (NVMe sobre InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para o SLES 12, você cria um sistema de arquivos no namespace e monta o sistema de arquivos.
