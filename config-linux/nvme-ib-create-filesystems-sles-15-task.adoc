...
---
= Criar sistemas de arquivos na Série E - Linux RHEL 8, RHEL 9, RHEL 10, SLES 15 e SLES 16 (NVMe sobre InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para RHEL 8, RHEL 9, RHEL 10, SLES 15 e SLES 16, você cria um sistema de arquivos no dispositivo nvme nativo e monta o sistema de arquivos.
