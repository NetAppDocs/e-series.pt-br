...
---
= Configurar seu storage usando o Gerenciador de sistemas do SANtricity - Linux (NVMe sobre RoCE)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após configurar o armazenamento no SANtricity System Manager, link:nvme-roce-configure-switch-task.html["configurar os switches"].
