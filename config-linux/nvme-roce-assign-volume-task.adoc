...
---
= Atribuir um volume usando o Gerenciador de sistema do SANtricity - Linux (NVMe sobre RoCE)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Passos
. No painel esquerdo da interface do SANtricity System Manager, selecione menu:Storage[Hosts].
...
.O que se segue?
Após atribuir um volume, link:nvme-roce-display-volumes-visible-host-task.html["Exibir os volumes visíveis para o host"].
