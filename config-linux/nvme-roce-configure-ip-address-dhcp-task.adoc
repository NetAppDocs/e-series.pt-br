...
---
= Configurar endereços IP usando DHCP no e-Series - Linux (NVMe sobre RoCE)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após configurar os endereços IP usando DHCP, link:nvme-roce-access-sam-setup-wizard-task.html["configurar seu armazenamento usando SANtricity System Manager"].
