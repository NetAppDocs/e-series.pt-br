...
---
= Criar um host usando o Gerenciador de sistema do SANtricity - Linux (NVMe sobre RoCE)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Passos
. No painel esquerdo, selecione menu:Storage[Hosts].
...
Tipo de sistema operacional de host
 a| 
Selecione a seguinte opção na lista suspensa:
...
.O que se segue?
Após criar o host, link:nvme-roce-assign-volume-task.html["atribuir um volume através do SANtricity System Manager"].
