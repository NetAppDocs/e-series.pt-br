...
.Antes de começar
Você precisa estar executando a versão mais recente e compatível do sistema operacional RHEL 8, RHEL 9, RHEL 10, SLES 12, SLES 15 ou SLES 16 com o pacote de serviços adequado. Veja o https://mysupport.netapp.com/matrix["Ferramenta de Matriz de interoperabilidade do NetApp"^] Para obter uma lista completa dos requisitos mais recentes.
