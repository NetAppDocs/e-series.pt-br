...
summary: Configurar o software multipath para fornecer um caminho redundante para o storage array no caso de um dos caminhos físicos ser interrompido. 
---
= Configurar o software multipath no e-Series - Linux (SRP em InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
