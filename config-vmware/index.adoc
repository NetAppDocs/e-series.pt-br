...
* https://configmax.vmware.com/home["Máximos de configuração do VMware"^] -- descreve como configurar o armazenamento virtual e físico para permanecer dentro dos máximos permitidos que o ESX/ESXi suporta.
