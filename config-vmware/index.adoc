...
** link:nvme-roce-perform-specific-task.html["NVMe em RoCE"]
...
* https://www.netapp.com/pdf.html?item=/media/17017-tr4789.pdf["Guia de configuração da VMware para integração iSCSI SANtricity da série e com o ESXi 6.X."^] Fornece detalhes técnicos sobre a integração do iSCSI com o VMware.
