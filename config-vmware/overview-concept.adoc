...
|===
Caso essas premissas não sejam adequadas para a sua instalação, ou se você quiser mais informações conceituais, consulte o seguinte relatório técnico: https://www.netapp.com/pdf.html?item=/media/17017-tr4789.pdf["Guia de configuração da VMware para integração iSCSI SANtricity da série e com o ESXi 6.X."^]
