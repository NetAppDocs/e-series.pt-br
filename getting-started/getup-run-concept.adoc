...
Para instalar o E-Series hardware, acesse as instruções de instalação e configuração para seu array de storage e tipo de shelf (se aplicável):

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["Sistema de storage EF50 ou EF80"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["Ajuda online do SANtricity System Manager para 12.0x"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["Ajuda online do Gestor de sistema do SANtricity para 11,9x"^]
