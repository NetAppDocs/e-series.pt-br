...
Alguns dos modelos de array E-Series disponíveis são mostrados abaixo. Para obter uma lista completa de modelos de array E-Series e suas especificações de hardware, consulte o NetApp Hardware Universe em  https://hwu.netapp.com["NetApp Hardware Universe"^].

* EF50 series -- nível básico, totalmente flash, totalmente NVMe
* Série EF80 -- midrange all flash, all NVMe
...
NOTE: Para SANtricity OS 11.80GA ou posterior, todas as portas USB são desativadas enquanto SANtricity OS está em execução.
...
+
--
* Suporta unidades SSD NVMe com as seguintes capacidades:
+
** 3,8 TB
** 7,6 TB
** 15,3 TB
...
* Suporta até 24 SSD NVMe no compartimento do controlador.
* Suporte para uma ou duas placas de interface de host por controlador.
* Suporte para placa entre controladores e cabos para comunicação entre dois controladores.
+

NOTE: É crucial conectar os cabos de espelhamento corretamente ao configurar seu sistema EF50. Para obter mais informações, consulte  https://docs.netapp.com/us-en/e-series/install-hw-ef50-ef80/install-cable.html#step-1-cable-the-inter-controller-mirroring-connections["Conecte os cabos de espelhamento entre os controladores - EF50 e EF80"].
...
* Suporta até 24 SSD NVMe no compartimento do controlador.
* Suporte para uma, duas ou três placas de interface de host por controlador.
* Suporte para placa entre controladores e cabos para comunicação entre dois controladores.
+

NOTE: É crucial conectar os cabos de espelhamento corretamente ao configurar seu sistema EF80. Para mais informações, consulte  https://docs.netapp.com/us-en/e-series/install-hw-ef50-ef80/install-cable.html#step-1-cable-the-inter-controller-mirroring-connections["Conecte os cabos de espelhamento entre os controladores - EF50 e EF80"].
