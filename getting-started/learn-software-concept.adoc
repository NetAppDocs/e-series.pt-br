...
Unified Manager é um software baseado na Web usado para gerenciar todo o seu domínio. A partir de uma visão central, você pode ver o status de todos os arrays E-Series e EF-Series mais recentes, como EF50, EF80, E4000, E2800, EF280, EF300, E5700, EF570, EF600, EF300C e EF600C. Você também pode executar operações em lote nos arrays de storage selecionados.
...
A interface de linha de comando (CLI) é um aplicativo de software que fornece uma maneira de configurar e monitorar arrays de storage. Usando a CLI, você pode executar comandos a partir de um prompt do sistema operacional, como o  `DOS C:` prompt, um caminho do sistema operacional Linux ou um caminho do sistema operacional Solaris.
