...
---
= Instale as bandejas no gabinete 3040 40U - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode instalar as seguintes bandejas de controlador/unidade e bandejas de expansão de unidade no gabinete E-Series 3040 40U.

Se as suas bandejas de unidade de controladora ou bandejas de unidade de expansão não estiverem listadas abaixo, veja  https://hwu.netapp.com["NetApp Hardware Universe"^] para verificar se as suas bandejas de unidade de controladora ou bandejas de unidade de expansão são suportadas.
