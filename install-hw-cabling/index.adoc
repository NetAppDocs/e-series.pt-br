...
NOTE: Se você não encontrar o seu rack de controladores (sistema de storage) listado abaixo, veja link:../getting-started/getup-run-concept.html["Início rápido para e-Series"^] e clique no link correspondente ao seu sistema de storage para acessar as informações de cabeamento.
...
Se você estiver instalando cabos para qualquer uma das seguintes configurações, consulte https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["Adição de gavetas de unidade IOM a uma gaveta de controladora E27XX, E56XX ou EF560 existente."^]
...
|===
Para obter informações sobre a cablagem necessária para suportar as funcionalidades de espelhamento, consulte o  https://www.netapp.com/pdf.html?item=/media/17133-tr4656.pdf["Descrições e Guia de implantação dos recursos de espelhamento síncrono e assíncrono"^].
