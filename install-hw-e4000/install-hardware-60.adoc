...
---
= Instale o material de fixação - E4060
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Uma prateleira vazia pesa aproximadamente 134 lb (61 kg). É necessário um elevador mecânico ou quatro pessoas usando alças de elevação para mover uma prateleira vazia com segurança.
