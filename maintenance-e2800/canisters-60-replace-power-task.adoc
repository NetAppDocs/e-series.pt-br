...
---
= Substitua o recipiente de alimentação E2800 (60 unidades)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2860_de460c_psu_w_callouts_maint-e2800.gif[28 dwg e2860 de460c psu w callouts mint e2800]
