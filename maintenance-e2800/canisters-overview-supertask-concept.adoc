...
image::../media/28_dwg_e2812_power_fan_canisters.gif[28 dwg e2812 latas de ventilador de energia]
...
image::../media/28_dwg_de460c_rear_no_callouts_maint-e2800.gif[28 dwg de460c traseiro sem legenda e2800]

A figura a seguir mostra um recipiente de alimentação:

image::../media/28_dwg_e2860_de460c_psu_maint-e2800.gif[28 dwg e2860 de460c fonte de alimentação e2800]
...
image::../media/28_dwg_e2860_de460c_single_fan_canister_no_callouts_maint-e2800.gif[28 dwg e2860 de460c recipiente de ventilador único sem legenda-maint e2800]
