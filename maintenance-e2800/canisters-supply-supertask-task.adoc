...
+
image::../media/28_dwg_913w_power_supply_back_view_maint-e2800.gif[28 dwg 913w fonte de alimentação back view manint e2800]
...
+
image::../media/drw_2600_psu_maint-e2800.gif[drw 2600 psu manint e2800]
