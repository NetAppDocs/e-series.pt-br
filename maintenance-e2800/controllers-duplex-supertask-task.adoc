...
---
= Substitua um controlador na configuração duplex - E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
... Selecione *hardware*.
... Se a imagem mostrar as unidades de disco, selecione *Mostrar parte traseira da prateleira* para mostrar os controladores
...
+
image::../media/28_dwg_e2800_remove_battery_maint-e2800.gif[Remova a bateria do recipiente do controlador]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Remova a placa frontal]
...
+
image::../media/28_dwg_e2800_insert_battery_maint-e2800.gif[Reinstale a bateria]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Reinstale a placa frontal]
...
+
image::../media/28_dwg_e2824_remove_controller_canister_maint-e2800.gif[Reinstale o recipiente do controlador]
...
+
image::../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif[Reinstale o recipiente do controlador]
