...
---
= Substitua a unidade no E2800 (compartimento de 60 unidades)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/2860_dwg_attn_led_on_drawer_maint-e2800.gif[2860 dwg attn led na gaveta manint e2800]
...
+
image::../media/2860_dwg_amber_on_drive_maint-e2800.gif[2860 dwg âmbar na manutenção da unidade e2800]
...
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e2800.gif[28 dwg e2860 de460c atenção led drive manint e2800]
...
+
image::../media/trafford_drive_rel_button_maint-e2800.gif[trafford drive rel button manut e2800]
