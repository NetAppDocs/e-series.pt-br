...
---
= Substitua a gaveta da unidade no E4000 (compartimento de 60 unidades)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e2800.gif[Punho do recipiente da ventoinha]
...
+
image::../media/trafford_cable_rail_1_maint-e2800.gif[Corrente de cabos e conetores para a gaveta da unidade]
...
+
image::../media/trafford_cable_rail_3_maint-e2800.gif[Anel laranja para calha vertical e corrente de cabo para a gaveta da unidade]
...
+
image::../media/trafford_cable_rail_2_maint-e2800.gif[Anel laranja para calha horizontal e corrente de cabo para a gaveta da unidade]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e2800.gif[Utilize a pega do came para levantar a unidade da gaveta]
...
+
image::../media/92_pht_de6600_drive_drawer_release_lever_maint-e2800.gif[Solte a alavanca para remover a gaveta]
...
+
image::../media/92_pht_de6600_lock_out_tumbler_detail_maint-e2800.gif[Patilha de bloqueio e guia da gaveta]
...
+
image::../media/2860_dwg_both_guide_rails_maint-e2800.gif[Guias horizontais e verificáveis]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e2800.gif[Utilize a pega para baixar a unidade na gaveta]
