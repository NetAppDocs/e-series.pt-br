...
[role="lead"]
Tem de substituir a bateria afetada no seu aparelho E4000 se o Guru de recuperação no Gestor do sistema SANtricity indicar o estado "Falha na bateria" ou "Substituição da bateria necessária". Para proteger os seus dados, a bateria tem de ser substituída o mais rapidamente possível.
