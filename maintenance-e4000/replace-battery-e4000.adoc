...
+
... Selecione *hardware*.
... Se o gráfico mostrar as unidades, selecione *Controller & Components* para exibir os controladores
...
+
.. Selecione *Storage › Volumes*. Na página *All Volumes*, verifique se os volumes estão distribuídos aos seus proprietários preferenciais. Selecione *More › Change ownership* para visualizar os proprietários dos volumes
.. Se todos os volumes pertencerem ao proprietário preferencial, continue para a etapa 4.
