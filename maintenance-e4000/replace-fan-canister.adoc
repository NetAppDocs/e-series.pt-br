...
---
= Substitua o recipiente do ventilador E4000 (60 unidades)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode substituir um coletor de ventilador em um array E4000 por um compartimento de 60 unidades, que inclui os seguintes tipos de gaveta:
