...
+
.. Selecione *hardware*.
.. Olhe para o ícone do ventilador image:../media/sam1130_ss_hardware_fan_icon_maint-e5700.gif[""]à direita das listas suspensas *Shelf* para determinar qual prateleira tem o recipiente do ventilador com falha.
+
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_led_callout_maint-e5700.gif[28 dwg e2860 de460c recipiente de ventilador único com led callout manint e5700]
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_orange_tab_callout_maint-e5700.gif[28 dwg e2860 de460c recipiente de ventilador único com guia laranja chamada-maint e5700]
