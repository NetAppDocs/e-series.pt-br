...
. Na página inicial do SANtricity System Manager, selecione menu:Storage[Operations in Progress]. Aguarde a conclusão de todas as operações antes de prosseguir para a próxima etapa.
