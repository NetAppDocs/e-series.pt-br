...
--
Para obter informações sobre a instalação dos novos controladores EF80 e EF50, consulte link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller["EF50 e EF80 - Etapa 7: instale o controlador"^].
