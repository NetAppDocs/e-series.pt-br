...
. Se a caixa de diálogo Resolve Self-Signed Certificates for aberta, revise as informações exibidas para os certificados não confiáveis. Para mais informações, você também pode clicar nas reticências no final da tabela e selecionar *View* no menu pop-up.
. Execute um dos seguintes procedimentos:
+
