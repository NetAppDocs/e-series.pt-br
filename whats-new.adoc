...
[role="lead"]
A tabela a seguir descreve os novos recursos nas versões mais recentes do SANtricity OS para gerenciamento integrado dos controladores EF80, EF50, E4000, EF300, EF600, E2800/EF280 e E5700/EF570.



[[new-features-in-version-12-0r1]]
== Novos recursos na versão 12.0R1

Esta versão contém apenas pequenas alterações e nenhum novo recurso. Para mais informações sobre as alterações nesta versão, consulte o E-Series SANtricity OS 12.0R1 README.
...
NOTE: A versão 12.0 do SANtricity OS é compatível apenas com os novos sistemas de storage all-flash EF80 e EF50.
...
| Novo recurso | Descrição 
 ...
 a| 
Suporte atualizado para versão de firmware IOM/DCM
 a| 
Novas versões de firmware IOM/DCM agora são compatíveis com os seguintes modelos IOM/DCM:
...
Esta versão contém apenas correções de defeitos e nenhum novo recurso. Para obter mais informações sobre as alterações nesta versão, consulte o E-Series SANtricity OS 11.90R5 README.
...
`-identifyDevices` parâmetro
 a| 
Um novo `-identifyDevices` parâmetro está agora disponível no SMcli. Este novo parâmetro permite que você procure todos os dispositivos de bloco nativos SCSI associados aos seus arrays de storage. Para mais informações, consulte link:https://docs.netapp.com/us-en/e-series-cli/get-started/downloadable-smcli-parameters.html#identify-Devices["Parâmetros de linha de comando SMcli para download"^].
...
Estatísticas do Kernel Ethernet
 a| 
Uma nova opção de Estatísticas do Kernel Ethernet agora está disponível na página Exibir Pacotes de Estatísticas iSCSI no System Manager. Essa nova opção permite visualizar estatísticas dos drivers de kernel da plataforma do dispositivo iSCSI. Para mais informações, consulte link:https://docs.netapp.com/us-en/e-series-santricity/sm-support/view-iscsi-statistics-packages-support.html["Visualizar pacotes de estatísticas iSCSI"^].
